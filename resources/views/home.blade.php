...
<div class="container mx-auto col-8">
    <div class="row mx-auto">
        ...
        <div class="col-8 pt-3">
            ...
            <div class="pt-4 fs-6"><strong>zakaria el hadi</strong> </div>
            <div class="row">
                <div class=" text-muted fs-5 " >Photographie et vidéographie</div>
                <div class="fw-normal fs-6">ENSAK Kenitra 🇲🇦 <br>Génie informatique</div>               
            </div>
            <div class="row">
